<?php
/**
 * @package add-icon-next-to-file
 */
/*
Plugin Name: Add icon next to pdf's word excel and ppt docs
Description: Add icon next to pdf's word excel and ppt docs
...
/* adds icon next to pdf's word excel and ppt docs*/ 
